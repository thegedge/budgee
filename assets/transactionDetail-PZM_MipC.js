import{B as A,i as E,T as c,a as m,M as $,b as o,A as u,d as R,m as W,c as b,e as O,f as F,t as L,g as G,n as N,r as p,h as U}from"./index-B1dGPar4.js";var V=Object.defineProperty,q=Object.getOwnPropertyDescriptor,I=a=>{throw TypeError(a)},h=(a,t,e,n)=>{for(var d=n>1?void 0:n?q(t,e):t,g=a.length-1,_;g>=0;g--)(_=a[g])&&(d=(n?_(t,e,d):_(d))||d);return n&&d&&V(t,e,d),d},f=(a,t,e)=>t.has(a)||I("Cannot "+e),y=(a,t,e)=>(f(a,t,"read from private field"),e?e.call(a):t.get(a)),w=(a,t,e)=>t.has(a)?I("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),x=(a,t,e,n)=>(f(a,t,"write to private field"),t.set(a,e),e),s=(a,t,e)=>(f(a,t,"access private method"),e),l,i,v,T,k,S,M,C,D,B,z,P;let r=class extends A(E){constructor(){super(...arguments),w(this,i),this.transactionId="",this._tags=[],this._relatedTransactions=[],this._monthlySpend=[],w(this,l,[])}connectedCallback(){super.connectedCallback(),s(this,i,v).call(this);const a=R(()=>s(this,i,v).call(this),300);Promise.all([c.subscribe(a),m.subscribe(a),$.subscribe(a)]).then(t=>{x(this,l,t)})}disconnectedCallback(){super.disconnectedCallback();for(const a of y(this,l))a.unsubscribe();x(this,l,[])}render(){if(!this._transaction)return o`
        <p>Loading...</p>
      ...
      ${a.merchantId?u:o`
            <button class="create-rule" @click=${()=>s(this,i,z).call(this,a)}>
