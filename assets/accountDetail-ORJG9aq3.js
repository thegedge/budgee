import{B as R,i as D,b as s,h as I,j as E,k as f,T as M,A as B,e as L,t as O,f as F,n as W,r as h,g as G,m as K,c as b,d as U}from"./index-ChNysiRj.js";var V=Object.defineProperty,Y=Object.getOwnPropertyDescriptor,y=t=>{throw TypeError(t)},u=(t,a,e,r)=>{for(var d=r>1?void 0:r?Y(a,e):a,g=t.length-1,i;g>=0;g--)(i=t[g])&&(d=(r?i(a,e,d):i(d))||d);return r&&d&&V(a,e,d),d},$=(t,a,e)=>a.has(t)||y("Cannot "+e),p=(t,a,e)=>($(t,a,"read from private field"),e?e.call(t):a.get(t)),q=(t,a,e)=>a.has(t)?y("Cannot add the same private member more than once"):a instanceof WeakSet?a.add(t):a.set(t,e),o=(t,a,e)=>($(t,a,"access private method"),e),n,v,x,_,m,w,k,S,T,C,A,P,z,N;let c=class extends R(D){constructor(){super(...arguments),q(this,n),this.accountId="",this._transactions=null,this._editingName=!1,this._timeRange=12,this._currentPage=1,this._pageSize=25}connectedCallback(){super.connectedCallback(),o(this,n,v).call(this)}render(){if(!this._account)return s`
        <p>Loading…</p>
