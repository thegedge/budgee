import{B as E,i as R,T as c,a as m,M as $,b as o,A as u,d as W,m as A,c as b,e as O,f as F,g as L,t as G,h as N,n as U,r as p,j as V}from"./index-C00rc0lP.js";var q=Object.defineProperty,H=Object.getOwnPropertyDescriptor,I=a=>{throw TypeError(a)},h=(a,t,e,n)=>{for(var d=n>1?void 0:n?H(t,e):t,g=a.length-1,_;g>=0;g--)(_=a[g])&&(d=(n?_(t,e,d):_(d))||d);return n&&d&&q(t,e,d),d},v=(a,t,e)=>t.has(a)||I("Cannot "+e),y=(a,t,e)=>(v(a,t,"read from private field"),e?e.call(a):t.get(a)),w=(a,t,e)=>t.has(a)?I("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(a):t.set(a,e),x=(a,t,e,n)=>(v(a,t,"write to private field"),t.set(a,e),e),i=(a,t,e)=>(v(a,t,"access private method"),e),l,s,f,T,S,k,M,C,D,z,B,P;let r=class extends E(R){constructor(){super(...arguments),w(this,s),this.transactionId="",this._tags=[],this._relatedTransactions=[],this._monthlySpend=[],w(this,l,[])}connectedCallback(){super.connectedCallback(),i(this,s,f).call(this);const a=W(()=>i(this,s,f).call(this),300);Promise.all([c.subscribe(a),m.subscribe(a),$.subscribe(a)]).then(t=>{x(this,l,t)})}disconnectedCallback(){super.disconnectedCallback();for(const a of y(this,l))a.unsubscribe();x(this,l,[])}render(){if(!this._transaction)return o`
        <p>Loading...</p>
      `;const a=this._transaction;return o`
      <span class="back-link" @click=${i(this,s,P)}>&larr; Back to transactions</span>
      ...
      <div class="section">
        ...
        <tag-autocomplete
          ...
          @tag-selected=${i(this,s,k)}
          @tag-created=${i(this,s,M)}
          @tag-removed=${t=>i(this,s,C).call(this,t.detail.tagId)}
        ></tag-autocomplete>
      </div>

      ${a.merchantId?u:o`
            <button class="create-rule" @click=${()=>i(this,s,B).call(this,a)}>
    ...
    `];h([U({type:String})],r.prototype,"transactionId",2);h([p()],r.prototype,"_transaction",2);h([p()],r.prototype,"_tags",2);h([p()],r.prototype,"_merchant",2);h([p()],r.prototype,"_relatedTransactions",2);h([p()],r.prototype,"_monthlySpend",2);r=h([V("transaction-detail")],r);export{r as TransactionDetail};
